        ...
        <div className="flex-shrink-0 w-96">
          <div className="bg-gradient-to-br from-gray-900 to-black rounded-[3.5rem] p-3 shadow-2xl border-[12px] border-gray-900 relative">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-100 rounded-[3rem] h-[680px] flex flex-col overflow-hidden">
              <div className="bg-gradient-to-r from-amber-500 to-orange-500 p-6 pt-12 text-white text-center">
                <div className="text-3xl font-bold mb-1">HuevApp</div>
                <p className="text-amber-100 text-sm">Clasificación Profesional</p>
              </div>
              ...
              <div className="flex-1 p-4 space-y-3">
                <div className="bg-white/95 backdrop-blur rounded-2xl p-4 text-center shadow-lg">
                  ...
                  <p className="text-sm text-gray-600 mt-1">Clasificados</p>
                </div>
                ...
                {[
                  ...
                  const Icon = cat.icon;
                  return (
                    <div key={cat.key} className="bg-white rounded-xl p-3 shadow-md border-2" style={{ borderColor: cat.color }}>
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-2xl font-bold" style={{ color: cat.color }}>{counts[cat.key]}</span>
                      </div>
                    </div>
                  );
                })}
                ...
                {counts.defective > 0 && (
                  <div className="bg-red-50 rounded-xl p-3 shadow-md border-2 border-red-500">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        <Trash2 size={28} className="text-red-600" />
                        <div>
                          <p className="text-sm font-bold text-red-700">DESCARTADOS</p>
                          <p className="text-xs text-red-600">&lt;35g</p>
                        </div>
                      </div>
                      <span className="text-2xl font-bold text-red-600">{counts.defective}</span>
                    </div>
                  </div>
                )}
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-green-500 to-emerald-600 text-white py-3 rounded-xl text-lg font-bold shadow-lg hover:scale-105 transition"
                >
                  Terminar Conteo
                </button>
              </div>
        ...
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 backdrop-blur-sm">
          <div className="bg-white rounded-3xl p-12 max-w-lg shadow-2xl text-center">
            ...
            <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-2xl p-8 mb-8">
              ...
              <p className="text-2xl text-gray-700 mb-4">huevos clasificados</p>
              {counts.defective > 0 && (
                <p className="text-xl text-red-600">{counts.defective} huevos descartados</p>
              )}
            </div>
            <button onClick={handleRestart} className="bg-gradient-to-r from-amber-500 to-orange-500 text-white px-16 py-6 rounded-2xl text-3xl font-bold hover:from-amber-600 hover:to-orange-600 transition shadow-lg">
              Nuevo Conteo
            </button>
          </div>
        </div>
